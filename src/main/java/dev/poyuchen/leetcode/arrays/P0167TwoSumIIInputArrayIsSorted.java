...
public final class P0167TwoSumIIInputArrayIsSorted {
    ...
    public static void main(String[] args) {
        var solution = new P0167TwoSumIIInputArrayIsSorted();

        Checks.checkArrayEquals(new int[]{1, 2}, solution.twoSum(new int[]{2, 7, 11, 15}, 9), "example 1");
        Checks.checkArrayEquals(new int[]{1, 3}, solution.twoSum(new int[]{2, 3, 4}, 6), "example 2");
        Checks.checkArrayEquals(new int[]{1, 2}, solution.twoSum(new int[]{-1, 0}, -1), "example 3");
        Checks.checkArrayEquals(new int[]{2, 3}, solution.twoSum(new int[]{1, 2, 4, 8}, 6), "middle pair");

        System.out.println("P0167TwoSumIIInputArrayIsSorted checks passed.");
    }
}
